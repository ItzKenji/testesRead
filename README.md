...
<img src="https://github.com/rocketseat-education/nlw-05-reactjs/blob/main/.github/podcastr.png?raw=true" alt="ilustração da aplicação" />

<p align="justify">O <strong>Podcastr</strong> é uma aplicação volta à <strong>exibição e reprodução de episódios podcast</strong>. Permitindo que o usuário tenha um acesso único a listagem dos episódios, através deste Web site.</p>
...
- [x] Listasgem de todos episódios
